                ...
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <div class="table-responsive">
                        <a href="{{route('staff.create')}}">
                            <button class=" btn-success ">Add Staff <i class="fa fa-plus"></i> </button>
                            ...
                            <tbody>
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td>{{ $user->email }}</td>
                                        <td>
                                            <a class="btn btn-sm btn-primary" href="{{ route('staff.edit', $user->id) }}">Update</a>
                                            ...
                                            <div class="modal fade" id="deleteModal{{ $user->id }}" tabindex="-1" aria-labelledby="deleteModalLabel{{ $user->id }}" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                            <form action="{{ route('staff.destroy', $user->id) }}" method="POST" enctype="multipart/form-data">
                                                                @csrf
                                                                @method('DELETE')

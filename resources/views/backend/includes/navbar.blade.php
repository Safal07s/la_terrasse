       ...
       <div class="content" style="margin-top: -5rem">
        ...
        <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
            <a href="{{url('/index')}}" class="navbar-brand d-flex d-lg-none me-4">
                <h2 class="text-primary mb-0"><i class=" ">The Calm</i></h2>
            </a>
            ...
            <div class="navbar-nav align-items-center ms-auto">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                        <img class="rounded-circle me-lg-2" src="{{asset('backend_assets/img/user.png')}}" alt="" style="width: 40px; height: 40px;">
